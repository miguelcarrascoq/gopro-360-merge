...
On macOS release zips, prefer opening `Gopro360Merge.app`. For ad-hoc (non-notarized) builds only, use `xattr -cr` or `Open GUI.command` if Gatekeeper blocks the first launch.
